          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-2">
            {tracks.map((item, i) => (
              ...
              >
                ...
                <div>
                  <div className="text-[10px] font-bold tracking-[.18em] text-cyan-300/70">
                    0{i + 1}
                  </div>
                  <h2 className="mt-1.5 text-lg font-bold text-white transition-colors group-hover:text-cyan-200 md:text-xl">
                    {item.title}
                  </h2>
        ...
        <div className="container-codely">
          ...
          >
            <div>
              ...
              <h2 className="mt-4 text-2xl font-bold leading-[1.38] text-white sm:text-3xl md:text-4xl md:leading-[1.35]">
                {t(
