        ...
        <div className="container-codely grid gap-8 lg:grid-cols-[1.15fr_.85fr]">
          ...
          >
            <div className="contact-side-card">
              ...
              <h2 className="mt-6 text-2xl font-bold text-white">{t("تواصل مباشر", "Direct contact")}</h2>
              ...
              <a
                ...
                className="mt-6 block break-all text-base font-bold text-white transition-colors hover:text-codely-cyan"
                dir="ltr"
              >
                {COMPANY_INFO.email}
              </a>
