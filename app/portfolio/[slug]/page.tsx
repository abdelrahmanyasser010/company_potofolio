    ...
    <div>
        ...
        <div className="container-codely py-16 md:py-24">
          ...
          <div className="mt-10 grid items-center gap-10 lg:grid-cols-[.85fr_1.15fr]">
            ...
            >
              ...
              <h1 className="mt-5 text-3xl font-bold leading-[1.35] text-white sm:text-4xl md:text-6xl md:leading-[1.28]">
      ...
      <section className="section-space">
        <div className="container-codely grid gap-12 lg:grid-cols-[.48fr_1fr]">
          <div className="text-xs font-bold uppercase tracking-[.18em] text-codely-cyan">
            01 / {t("المشكلة", "The challenge")}
          </div>
          <div>
            <h2 className="text-2xl font-bold leading-[1.38] text-white sm:text-3xl md:text-4xl md:leading-[1.35]">
        ...
        <section className="section-space overflow-hidden">
          <div className="container-codely">
            <div className="grid gap-10 lg:grid-cols-[.48fr_1fr]">
              ...
              <div>
                <h2 className="max-w-3xl text-2xl font-bold leading-[1.38] text-white sm:text-3xl md:text-4xl md:leading-[1.35]">
              ...
              {project.gallery.map((item, index) => (
                ...
                >
                  ...
                  <figcaption className="grid gap-2 border-t border-white/8 p-5 md:grid-cols-[.45fr_1fr] md:gap-6 md:p-6">
                    <div className="text-sm font-bold text-white transition-colors group-hover:text-cyan-200">
        ...
        <div className="container-codely">
          ...
          >
            ...
            <div className="mt-4 flex flex-col justify-between gap-7 md:flex-row md:items-end">
              <h2 className="max-w-2xl text-2xl font-bold leading-[1.38] text-white sm:text-3xl md:text-4xl md:leading-[1.35]">
                {t(
              ...
              <Link
                href="/contact"
                className="shrink-0 rounded-full bg-white px-7 py-3.5 text-sm font-bold text-[#070b1f] shadow-lg transition-transform duration-200 hover:scale-105"
              >
