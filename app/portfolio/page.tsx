      ...
      >
        <div className={`${isFeatured ? "grid lg:grid-cols-[.9fr_1.1fr] h-full" : "flex flex-col h-full"}`}>
          ...
          >
            ...
            <h2 className="mt-3 text-2xl font-black text-white transition-colors group-hover:text-cyan-200 md:text-3xl">
            ...
            <div className="mt-7 flex items-center gap-2 text-xs font-black text-white transition-colors group-hover:text-codely-cyan mt-auto pt-4">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4 border-b border-white/10 pb-5">
                        ...
                        <h2 className="text-3xl font-black text-white">{t(catInfo.label_ar, catInfo.label_en)}</h2>
                      </div>
