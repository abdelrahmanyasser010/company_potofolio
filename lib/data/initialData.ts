...
export const INITIAL_PORTFOLIO: PortfolioItem[] = [
  ...
  },
  {
    slug: "drralbayan",
    title_ar: "درر البيان",
    title_en: "Dorar Al Bayan",
    eyebrow_ar: "متجر إلكتروني لبيع اللحوم الطازجة",
    eyebrow_en: "Fresh Meat E-commerce Store",
    category: "platform",
    summary_ar: "منصة تجارة إلكترونية متخصصة في بيع وتوصيل اللحوم الطازجة، مصممة لتوفير تجربة تسوق سلسة من تصفح الأقسام واختيار التقطيعات المناسبة حتى إتمام الطلب ومتابعة التوصيل.",
    summary_en: "An e-commerce platform specialized in selling and delivering fresh meat, designed to provide a seamless shopping experience from browsing cuts to checkout and delivery tracking.",
    challenge_ar: "بيع اللحوم عبر الإنترنت يتطلب نظام طلب مرن يسمح للعملاء باختيار التقطيع والتغليف والوزن المناسب، بالإضافة إلى ضرورة بناء ثقة مع العميل من خلال واجهة احترافية ومريحة.",
    challenge_en: "Selling meat online requires a flexible ordering system that allows customers to choose the cut, packaging, and weight, in addition to building trust through a professional and convenient interface.",
    solution_ar: "تم بناء متجر متكامل بواجهة مستخدم سهلة لتصفح المنتجات المتنوعة، مع نظام سلة وإتمام طلب مبسط، وتضمين أقسام لضمان الجودة والأسئلة الشائعة لتسهيل قرار الشراء.",
    solution_en: "Built a comprehensive store with an intuitive UI for browsing diverse products, a simplified cart and checkout system, and integrated quality guarantee and FAQ sections to facilitate purchasing decisions.",
    highlights_ar: ["متجر إلكتروني متكامل", "خيارات التقطيع والتغليف", "دورة إتمام طلب سريعة", "تجربة مستخدم مريحة", "إدارة الطلبات", "إجابة استفسارات العملاء"],
    highlights_en: ["Complete e-commerce store", "Custom cut & packaging options", "Fast checkout flow", "Smooth user experience", "Order management", "Customer FAQ"],
    technologies: ["E-commerce", "Web Platform", "UI/UX Design", "Responsive"],
    accent: "blue",
    visual: "pos",
    coverImage: "/projects/drralbayan/drralbayan-1.webp",
    website: "https://www.drralbayan.com/",
    galleryTitle_ar: "متجر درر البيان من الداخل",
    galleryTitle_en: "Dorar Al Bayan Store",
    galleryIntro_ar: "جولة داخل صفحات المتجر توضح تصميم الواجهات بداية من الصفحة الرئيسية وعرض الأقسام، مروراً بصفحات الثقة والأسئلة الشائعة، وصولاً إلى شاشة إتمام الطلب السلسة.",
  ...
  },
  {
    ...
    playStore: "https://play.google.com/store/apps/details?id=com.bub1.app",
  ...
  },
  {
    ...
    playStore: "https://play.google.com/store/apps/details?id=com.zone.app.zone",
  ...
  },
  {
    ...
    playStore: "https://play.google.com/store/search?q=ماي+فني",
  ...
  },
{
    ...
    playStore: "https://play.google.com/store/apps/details?id=com.medskai.app&hl=ar",
