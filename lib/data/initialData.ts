...
export const INITIAL_SERVICES: ServiceItem[] = [
  {
    ...
    description_ar: "من مواقع الشركات إلى منصات SaaS والأنظمة التشغيلية المعقدة، نبني تجربة واضحة وبنية قابلة للتوسع.",
  ...
  },
  {
    ...
    description_ar: "تطبيقات Flutter عملية وسريعة، مرتبطة بالـ Backend ومصممة لسيناريوهات الاستخدام الحقيقية.",
  ...
  },
  {
    ...
    description_ar: "لوحات إدارة للطلبات والمستخدمين والحسابات والتقارير والصلاحيات، مع تدفقات عمل واضحة وليست مجرد جداول.",
  ...
  },
  {
    ...
    description_ar: "نبني APIs منظمة وآمنة تربط تطبيقات الويب والموبايل وتتعامل مع الصلاحيات والبيانات والتكاملات الخارجية.",
  ...
  },
  {
    ...
    description_ar: "نحوّل خطوات العمل اليومية إلى نظام واحد أبسط: مبيعات، مخزون، شحن، تعليم، خدمات أو عمليات داخلية.",
  ...
  },
  {
    ...
    description_ar: "مراجعة مشروع قائم، تنظيف البنية، إصلاح الأخطاء، ربط APIs وتحسين تجربة الاستخدام بدون إعادة بناء عشوائية.",
...
export const INITIAL_PORTFOLIO: PortfolioItem[] = [
  ...
  },
  {
    ...
    accent: "amber",
    visual: "pos",
    coverImage: "/projects/tog/tog-ecosystem.webp",
  ...
  },
  {
    ...
    title_ar: "EduBridge",
    title_en: "EduBridge",
    eyebrow_ar: "Backend متعدد المدارس",
    eyebrow_en: "Multi-School Platform Backend",
    category: "platform",
    summary_ar: "بنية Backend لمنصة تعليمية متعددة المدارس، تفصل بيانات كل جهة عبر tenant_id وتخدم لوحة التحكم والتطبيقات من API واحدة منظمة.",
    summary_en: "A multi-school backend architecture separating each organization by tenant_id and serving dashboards and apps through a structured API layer.",
    challenge_ar: "تشغيل عدة مدارس على منصة واحدة يتطلب عزل البيانات، صلاحيات دقيقة، وقابلية للتوسع بدون تكرار البنية لكل عميل.",
    challenge_en: "Running multiple schools on one platform requires strict tenant isolation, permissions and scalability without duplicating infrastructure per client.",
    solution_ar: "Shared database/schema مع عزل tenant، Middleware لتحديد السياق، فهارس للبيانات، مصادقة Sanctum، وتجهيز للتوسّع بالـ queues والخدمات الخلفية.",
    solution_en: "A shared database/schema with tenant isolation, tenant-resolving middleware, indexed queries, Sanctum authentication and queue-ready architecture.",
    highlights_ar: ["Multi-tenancy", "مصادقة وصلاحيات", "API للوحة والتطبيق", "فصل بيانات الجهات", "Queues وإشعارات", "توثيق Endpoints وPostman"],
    highlights_en: ["Multi-tenancy", "Authentication & roles", "Dashboard & app APIs", "Tenant data isolation", "Queues & notifications", "Endpoint & Postman documentation"],
  ...
  },
  {
    ...
    title_ar: "منصة خدمات قانونية",
    title_en: "Legal Services Platform",
    eyebrow_ar: "استشارات وعقود رقمية",
    eyebrow_en: "Consultations & Digital Contracts",
    category: "web",
    summary_ar: "منصة ويب لإدارة الاستشارات والعقود والمدفوعات والإشعارات، مع لوحة تحكم مركزية وتجربة متعددة اللغات.",
    summary_en: "A web platform for consultations, contracts, payments and notifications with centralized administration and multilingual UX.",
    challenge_ar: "الخدمة القانونية تحتاج رحلة واضحة تحفظ بيانات العميل وتاريخ الطلبات والعقود وتعرض المستند النهائي بصورة منظمة وقابلة للمراجعة.",
    challenge_en: "Legal services need a clear journey that preserves client history, requests and contracts while producing organized, reviewable final documents.",
    solution_ar: "فصل واضح بين رحلة العميل والإدارة، قوالب عقود منظمة، إدارة دورة الطلب والمدفوعات، وإشعارات بريدية وداخل النظام.",
    solution_en: "A clear split between client and admin journeys, structured contract templates, request/payment lifecycle management and email/in-app notifications.",
    highlights_ar: ["إدارة الاستشارات", "قوالب وعقود PDF", "مدفوعات وإيصالات", "محفظة وبيانات عميل", "إشعارات", "عربي وإنجليزي"],
    highlights_en: ["Consultation management", "Contract templates & PDF", "Payments & receipts", "Client wallet & records", "Notifications", "Arabic & English"],
