      ...
      <div className="container-codely flex h-[78px] items-center justify-between gap-5">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
            <Link
              href="/contact"
              className="focus-ring inline-flex h-10 items-center gap-2 rounded-full bg-white px-5 text-[13px] font-black text-[#070b1f] shadow-[0_4px_20px_rgba(255,255,255,.15)] transition hover:shadow-[0_8px_30px_rgba(255,255,255,.25)]"
            >
        ...
        {open && (
          ...
          >
            <nav className="mx-auto flex max-w-7xl flex-col gap-2">
              ...
              <Link
                href="/contact"
                className="mt-2 rounded-2xl bg-white px-4 py-3.5 text-center text-sm font-black text-[#070b1f] shadow-lg"
              >
